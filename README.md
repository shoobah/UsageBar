...
**[Download for Mac — Apple Silicon](https://github.com/shoobah/UsageBar/releases/download/v1.1.0/UsageBar-1.1.0-AppleSilicon.dmg)** · [Latest release](https://github.com/shoobah/UsageBar/releases/latest) · [Report an issue](https://github.com/shoobah/UsageBar/issues)
...
- **Optional activity explanation.** Ask Codex for a short summary of likely local usage contributors based on recent task descriptions, token totals, model, and reasoning effort.
...
1. [Download the DMG](https://github.com/shoobah/UsageBar/releases/download/v1.1.0/UsageBar-1.1.0-AppleSilicon.dmg).
...
The popover shows your reset time in your Mac's local time zone. If Codex reports another allowance window, that appears separately with its window length and reset time.
